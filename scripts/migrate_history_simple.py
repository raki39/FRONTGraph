#!/usr/bin/env python3
"""
Migração simplificada para adicionar tabelas do sistema de histórico
"""
...
def get_database_url():
    ...
    # Usa as mesmas variáveis de ambiente que a API
    host = os.getenv("PG_HOST", "postgres")  # "postgres" dentro do Docker
